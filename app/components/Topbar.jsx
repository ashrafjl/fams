  ...
  return (
    <div className="flex items-center justify-between border-b border-light-border overflow-hidden">
      <div className="flex-1 relative h-[46px] leading-[46px]">
        ...
        <div className="flex items-center h-full relative text-[white] gap-3 sm:pl-[80px] pl-[40px]">
        <Phone classess={'size-5'}/>
        <p className="text-[16px] leading-4">+91 888 8888 888</p>
        </div>
      </div>
      <div className="flex-1 relative sm:pr-[80px] pr-[40px]">
        <div className="flex items-center self-end justify-end relative gap-3 w-[40%] ml-auto">
